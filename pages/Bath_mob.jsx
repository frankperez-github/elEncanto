            ...
            <div className="Garden_mob">
                ...
                <div className="X_Bar_mob">
                    <div className="arrow-div_mob">
                        <Image className="arrow_mob" src="/../public/imgs/prev.svg" width="90%" height="90%"/>
                    </div>
                    ...
                    <div className="arrow-div_mob">
                         <Image className="arrow_mob" src="/../public/imgs/next.svg" width="90%" height="90%"/>
                    </div>
                </div>
