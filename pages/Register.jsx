...
const Register = ()=> {
    ...
    const handleRegister = async(e)=>{
        ...
        if (password==confirmPassword) {
            try {
            const data = await fetch("https://elencantoapi.com/user/register/", {method:"POST", headers:{"Content-Type":"application/json"}, body:JSON.stringify({email, "first_name":firstName, "last_name":lastName, password })})
